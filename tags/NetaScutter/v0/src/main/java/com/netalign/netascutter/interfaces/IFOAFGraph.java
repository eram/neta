...
public interface IFOAFGraph
{
     ...
     * on graphs that contain a single FOAF document. For more 
     * general graphs that include triples from multiple documents 
     * (e.g. as the result of a scutter), then use the alternate 
     * version of this method, specifying the baseURI of the document 
     * being queried.
     ...
     * 
     * <p>
     * Find the primary person associated with a FOAF document from 
     * a specific URI. The algorithm first attempts to see whether 
     * the primary person is explicitly labelled (i.e. foaf:primaryTopic 
     * of a foaf:PersonalProfileDocument). Otherwise it looks for the 
     * author (foaf:maker, then dc:creator) of that document. 
     * </p>
     * 
     * @param base the URI of the document
     * @return the primary Person or null if not found
     */
     ...
     * 
     * <p>
     * Produces a list of Person objects, one for every foaf:Person 
     * in the graph, regardless of relationship or origin.
     * </p> 
     * 
