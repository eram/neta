    ...
    private String send(URL urlStr, Map<String, String> message, String method) {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new OutputStreamWriter(
            		connection.getOutputStream(), UTF8_ENCODING));
            
            StringBuilder outBuidler = new StringBuilder();
            for (Map.Entry<String, String> entry : message.entrySet()) {
                outBuidler.append(entry.getKey());
                outBuidler.append("=");
                outBuidler.append(URLEncoder.encode(entry.getValue(), UTF8_ENCODING));
                outBuidler.append("&");
            }
    ...
    private String readConnection(HttpURLConnection connection) { 	
        ...
        try {       	
            BufferedReader in = new BufferedReader(
                    new InputStreamReader(connection.getInputStream(), UTF8_ENCODING));        	
            String line;
