...
public class PtswReaderThread extends Thread {
	...
	public void defaultInit() {
    	PtswReader.NsFilter filter1 = handler.new NsFilter();
    	filter1.addNs(SIOC.NS);
    	filter1.addNs(FOAF.NS);    	
    	handler.addFilter(filter1);
    	PtswReader.DomainBlacklistFilter filter2 = handler.new DomainBlacklistFilter();
    	filter2.addToBlacklist("www.talkdigger.com");	
    	handler.addFilter(filter2); 
    	PtswReader.DomainBlacklistFilter filter3 = handler.new DomainBlacklistFilter();
