...
public class DrupalRESTTest {
    ...
    public void testGetNodeColumnKeyField() {
    	...
    	assertTrue( getString(result, VALUE).equals(Constants.POST)); 
    }
    ...
    public void testDeleteNodeColumnKey() {
    	...
    	String result = http.delete(host+Constants.NODE+SLASH+Constants.NID+SLASH+Integer.toString(nid)+POSTFIX);    	
