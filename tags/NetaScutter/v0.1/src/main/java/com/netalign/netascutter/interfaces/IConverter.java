...
public interface IConverter {
	 ...
	 * the <i>convertPost</i> method that treats the post as an actual post.
	 * Conversion is basically extraction of all the post fields to key-value entries, and
	 * addition of some other fields, depending on implementation.             
	 * @param person    an {@link ISiocPost} to convert
	 * @param urlStr    the URL of the RDF file this post was extracted from
	...
	/**
	 * Convert an {@link ISiocContainer} object to a map of strings.
	 * Conversion is basically extraction of all the container fields to key-value entries, and
	 * addition of some other fields, depending on implementation.             
	 * @param person    an {@link ISiocContainer} to convert
	 * @param urlStr    the URL of the RDF file this forum was extracted from
	 * @return          a map of strings with key-value entries of the container fields and values
	 */
	Map<String, String> convertContainer(ISiocContainer container, String urlStr);
	/**
