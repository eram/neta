...
public class PtswReader implements IDocHandler {
	 ...
	 * @see rdfdocument
	 */
	public static interface IUrlFilter {
		/**
	 ...
	 * @see IUrlFilter	
	 */
	public static class NsFilter implements IUrlFilter {
	 ...
	 * @see IUrlFilter
	 */
	public static class DomainBlacklistFilter implements IUrlFilter {
	 ...
	 * @see PtswReader
	 */
	private static class rdfdocument {
