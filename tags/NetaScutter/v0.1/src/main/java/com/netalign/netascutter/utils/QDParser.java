 ...
 * <br>
 * The <code>QDParser</code> class is <b>static</b>.<br>It receives a {@link Reader} and an {@link IDocHandler}.
 * <br>It reads from the Reader, expecting to read an XML file, and parses it, sending events to the IDocHandler:
 ...
 * <br><p>
 * The QDParser may not be stopped.
 * <p><br>
 * @see IDocHandler
 */
public class QDParser {
	...
	public static void parse(IDocHandler doc, Reader r) throws Exception {
		Stack st = new Stack();
		int depth = 0;
		int mode = PRE;
		int c = 0;
