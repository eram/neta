...
public class ModelUtils
{
    ...
    {
    	// captures subclasses of Post such as BoardPost
    ...
    public static boolean isSiocContainer(Resource resource)
    {
        return resource.hasProperty(RDF.type, SIOC.Container); 
    }
}